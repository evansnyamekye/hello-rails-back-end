...
Here is the link to the [Hello Rails Front-End](https://github.com/evansnyamekye/hello-rails-back-end/pull/1)repository.
...
```sh
git clone https://github.com/evansnyamekye/hello-rails-back-end
